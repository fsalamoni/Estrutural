...
type Tab = 'platforms' | 'categories' | 'settings';

const TABS: { key: Tab; label: string; icon: string }[] = [
  { key: 'platforms', label: 'Plataformas', icon: 'dashboard' },
        ...
        <header className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-8">
          <div>
            <h2 className="font-display text-2xl font-bold text-on-surface tracking-tight">
              {activeTab === 'platforms' && 'System Overview'}
        ...
        {activeTab === 'platforms' && (
          <>
            ...
            <section className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="glass-panel p-5 rounded-xl flex flex-col justify-between h-32 inner-glow-purple">
                <div className="flex items-center gap-1">
                  <span className="material-symbols-outlined text-on-primary-container text-sm">category</span>
                  <span className="font-label text-xs text-on-primary-container uppercase tracking-widest">Categorias</span>
                </div>
                <span className="font-display text-4xl font-black text-on-surface">
                  {categories.length}
                </span>
